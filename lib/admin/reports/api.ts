...
export async function getMarksReport(params: {
  ...
  const response = await fetch(
    `/api/admin/reports/marks/${params.cursoId}/${params.year}/${params.term}?${query.toString()}`,
    {
      method: 'GET',
      credentials: 'include',
      cache: 'no-store',
...
export function getMarksExportExcelUrl(params: {
  ...
  return `/api/admin/reports/marks/${params.cursoId}/${params.year}/${params.term}/export/excel?${query.toString()}`
}
...
export function getMarksExportPdfUrl(params: {
  ...
  return `/api/admin/reports/marks/${params.cursoId}/${params.year}/${params.term}/export/pdf?${query.toString()}`
}
...
export async function getAttendanceReport(params: {
  ...
  const response = await fetch(
    `/api/admin/reports/attendance/${params.cursoId}/${params.year}/${params.term}?${query.toString()}`,
    {
      method: 'GET',
      credentials: 'include',
      cache: 'no-store',
...
export function getAttendanceExportExcelUrl(params: {
  ...
  return `/api/admin/reports/attendance/${params.cursoId}/${params.year}/${params.term}/export/excel?${query.toString()}`
}
...
export function getAttendanceExportPdfUrl(params: {
  ...
  return `/api/admin/reports/attendance/${params.cursoId}/${params.year}/${params.term}/export/pdf?${query.toString()}`
}
...
export async function getHomeworkReport(params: {
  ...
  const response = await fetch(
    `/api/admin/reports/homework/${params.cursoId}/${params.year}/${params.term}?${query.toString()}`,
    {
      method: 'GET',
      credentials: 'include',
      cache: 'no-store',
...
export function getHomeworkExportExcelUrl(params: {
  ...
  return `/api/admin/reports/homework/${params.cursoId}/${params.year}/${params.term}/export/excel?${query.toString()}`
}
...
export function getHomeworkExportPdfUrl(params: {
  ...
  return `/api/admin/reports/homework/${params.cursoId}/${params.year}/${params.term}/export/pdf?${query.toString()}`
}
...
export async function getStudentSummaryReport(params: {
  ...
  const response = await fetch(
    `/api/admin/reports/student-summary/${params.cursoId}/${params.alumnoId}/${params.year}/${params.term}`,
    {
      method: 'GET',
      credentials: 'include',
      cache: 'no-store',
...
export function getStudentSummaryExportPdfUrl(params: {
  ...
  return `/api/admin/reports/student-summary/${params.cursoId}/${params.alumnoId}/${params.year}/${params.term}/export/pdf`
}
...
export async function getAttendanceRangeReport(params: {
  ...
  const response = await fetch(
    `/api/admin/reports/attendance-range/${params.cursoId}?${query.toString()}`,
    {
      method: 'GET',
      credentials: 'include',
      cache: 'no-store',
...
export async function getDeliveriesByTaskReport(params: {
  ...
  const response = await fetch(
    `/api/admin/reports/deliveries/${params.cursoId}/${params.tareaId}?${query.toString()}`,
    {
      method: 'GET',
      credentials: 'include',
      cache: 'no-store',
...
export async function getStudentAssessmentDetailReport(params: {
  ...
  const response = await fetch(
    `/api/admin/reports/student-assessments/${params.cursoId}/${params.alumnoId}/${params.year}/${params.term}?${query.toString()}`,
    {
      method: 'GET',
      credentials: 'include',
      cache: 'no-store',
...
export function getStudentAssessmentDetailExportPdfUrl(params: {
  ...
  return `/api/admin/reports/student-assessments/${params.cursoId}/${params.alumnoId}/${params.year}/${params.term}/export/pdf?${query.toString()}`
}