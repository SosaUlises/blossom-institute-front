...
export async function activateCourse(id: number): Promise<void> {
  const response = await fetch(`/api/admin/courses/${id}/activate`, {
    method: 'PUT',
    credentials: 'include',
  })
...
export async function deactivateCourse(id: number): Promise<void> {
  const response = await fetch(`/api/admin/courses/${id}/deactivate`, {
    method: 'PUT',
    credentials: 'include',
  })
...
export async function archiveCourse(id: number): Promise<void> {
  const response = await fetch(`/api/admin/courses/${id}/archive`, {
    method: 'PUT',
    credentials: 'include',
  })
