...
export const studentUi = {
  card: {
    feed:
      'rounded-[24px] border border-border/70 bg-card shadow-[0_14px_34px_-28px_rgba(15,23,42,0.25)] transition-all duration-200 ease-out hover:-translate-y-[1px] hover:border-primary/20 hover:shadow-[0_20px_44px_-30px_rgba(15,23,42,0.32)]',
    panel:
      'rounded-[30px] border border-border/60 bg-card/95 shadow-[0_18px_44px_-24px_rgba(15,23,42,0.16)]',
    item:
      'rounded-2xl border border-border/60 bg-background/75 transition-colors duration-200 ease-out hover:bg-muted/30',
    grade:
      'rounded-[24px] border border-border/60 bg-background/75 p-4 shadow-[0_14px_30px_-26px_rgba(15,23,42,0.16)] transition-colors duration-200 ease-out hover:border-primary/20 hover:bg-card sm:p-5',
    empty:
      'rounded-2xl border border-dashed border-border/70 bg-muted/15',
  },
  badge: {
    status:
      'inline-flex max-w-full w-fit shrink-0 items-center gap-1.5 rounded-full border px-3 py-1.5 text-left text-sm font-semibold leading-5 transition-colors duration-200 ease-out',
    secondary:
      'inline-flex max-w-full items-center gap-1.5 rounded-full border border-border/60 bg-background/75 px-2.5 py-1 text-left text-sm font-medium leading-5 text-muted-foreground transition-colors duration-200 ease-out',
    compact:
      'inline-flex w-fit items-center gap-1.5 rounded-full border px-2.5 py-1 text-xs font-semibold',
  },
  button: {
    secondaryCta:
      'inline-flex h-10 w-full items-center justify-center rounded-xl border border-border/70 bg-background px-3 text-sm font-semibold text-foreground transition-colors duration-200 ease-out hover:border-primary/20 hover:bg-muted/50 hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/30 active:scale-[0.99] sm:h-9 sm:w-fit',
    violetCta:
  ...
  icon: {
    lg: 'flex size-12 shrink-0 items-center justify-center rounded-2xl border shadow-sm transition-colors duration-200 ease-out',
    md: 'flex size-11 shrink-0 items-center justify-center rounded-2xl border transition-colors duration-200 ease-out',
    sm: 'flex size-8 shrink-0 items-center justify-center rounded-xl transition-colors duration-200 ease-out',
  },
  meta: {
