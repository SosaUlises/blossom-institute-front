                    ...
                    {report.items.length === 0 ? (
                      ...
                      report.items.map((item) => (
                        ...
                        >
                          ...
                          <td className="px-6 py-4 text-muted-foreground">{item.quizCount}</td>
                          <td className="px-6 py-4 text-muted-foreground">
                            {item.quizPromedio?.toFixed(2) ?? '-'}
                          </td>
                          <td className="px-6 py-4 text-muted-foreground">{item.testCount}</td>
                          <td className="px-6 py-4 text-muted-foreground">
                            {item.testPromedio?.toFixed(2) ?? '-'}
                          </td>
                          <td className="px-6 py-4 text-muted-foreground">{item.marksCount}</td>
