...
import type { ReporteHomeworkResponse } from '@/lib/reports/types'
      ...
      {report && (
        <>
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
            ...
            <Card className="border-border/70 bg-card/95">
              <CardContent className="p-5">
                <p className="text-xs uppercase tracking-wide text-muted-foreground">Homework total</p>
                <p className="mt-2 text-2xl font-bold text-foreground">
                  {report.resumen.totalHomework}
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-border/70 bg-card/95">
              <CardContent className="p-5">
                <p className="text-xs uppercase tracking-wide text-muted-foreground">Promedio curso</p>
                <p className="mt-2 text-2xl font-bold text-foreground">
                  {report.resumen.promedioHomeworkCurso?.toFixed(2) ?? '-'}
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-3 xl:grid-cols-4">
            <Card className="border-border/70 bg-card/95">
              <CardContent className="p-5">
                <p className="text-xs uppercase tracking-wide text-muted-foreground">Sin entregar</p>
                <p className="mt-2 text-2xl font-bold text-foreground">
                  {report.resumen.totalSinEntregar}
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-border/70 bg-card/95">
              <CardContent className="p-5">
                <p className="text-xs uppercase tracking-wide text-muted-foreground">Pend. corrección</p>
                <p className="mt-2 text-2xl font-bold text-foreground">
                  {report.resumen.totalPendientesCorreccion}
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-border/70 bg-card/95">
              <CardContent className="p-5">
                <p className="text-xs uppercase tracking-wide text-muted-foreground">Rehacer</p>
                <p className="mt-2 text-2xl font-bold text-foreground">
                  {report.resumen.totalRehacer}
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-border/70 bg-card/95">
              <CardContent className="p-5">
                <p className="text-xs uppercase tracking-wide text-muted-foreground">Aprobadas</p>
                <p className="mt-2 text-2xl font-bold text-foreground">
                  {report.resumen.totalAprobadas}
                </p>
              </CardContent>
            </Card>
          </div>
                ...
                <table className="w-full min-w-[1180px] text-sm">
                  <thead className="border-b border-border/70 bg-muted/30">
                    <tr className="text-left text-muted-foreground">
                      ...
                      <th className="px-5 py-4 font-medium">Total HW</th>
                      <th className="px-5 py-4 font-medium">Entregadas</th>
                      <th className="px-5 py-4 font-medium">Sin entregar</th>
                      <th className="px-5 py-4 font-medium">Pend. corrección</th>
                      <th className="px-5 py-4 font-medium">Rehacer</th>
                      <th className="px-5 py-4 font-medium">Aprobadas</th>
                      <th className="px-5 py-4 font-medium">Promedio</th>
                    </tr>
                  </thead>
                    ...
                    {report.items.length === 0 ? (
                      ...
                      report.items.map((item) => (
                        ...
                        >
                          ...
                          <td className="px-5 py-4 text-muted-foreground">{item.homeworkTotal}</td>
                          <td className="px-5 py-4 text-muted-foreground">{item.homeworkEntregadas}</td>
                          <td className="px-5 py-4 text-muted-foreground">{item.homeworkSinEntregar}</td>
                          <td className="px-5 py-4 text-muted-foreground">{item.homeworkPendientesCorreccion}</td>
                          <td className="px-5 py-4 text-muted-foreground">{item.homeworkRehacer}</td>
                          <td className="px-5 py-4 text-muted-foreground">{item.homeworkAprobadas}</td>
