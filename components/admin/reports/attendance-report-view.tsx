...
export function AttendanceReportView() {
  ...
  return (
    <ReportPageShell
      ...
      description="Analizá la asistencia consolidada por curso y trimestre con métricas detalladas por alumno."
      meta={
        <>
          <ReportMetaCard
            icon={BookOpen}
    ...
    >
      <ReportFilterPanel
        description="Seleccioná curso, año, trimestre y búsqueda opcional para generar el análisis de asistencia."
        error={error}
        action={
      ...
      {report && (
        <>
          ...
          <ReportResultsSection
            ...
            description="Vista consolidada de asistencia individual para el período seleccionado."
          >
                ...
                <tbody>
                  {report.items.length === 0 ? (
                    <ReportEmptyTableRow
                      ...
                      description="No encontramos registros de asistencia para este curso y período."
                    />
                  ) : (
            ...
            <div className="grid w-full gap-2 sm:grid-cols-2 sm:min-w-[260px]">
              <ReportExportButton
                ...
                filename={buildReportFilename(
                  ['asistencia', report.resumen.cursoNombre, report.resumen.year, `t${report.resumen.term}`],
                  'xlsx'
                )}
                href={
                  report && cursoId
