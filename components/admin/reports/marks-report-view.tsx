        ...
        <div className="relative flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 max-w-2xl text-[15px] leading-7 text-muted-foreground">
              Analizá el rendimiento de un curso por año y trimestre, con exportación en Excel o PDF.
            </p>
          </div>
        ...
        <div className="flex flex-col gap-6">
          <div className="space-y-1">
            ...
            <p className="text-sm leading-6 text-muted-foreground">
              Seleccioná curso, año, trimestre y búsqueda opcional para generar el análisis.
            </p>
          </div>
          ...
          <section className="rounded-[28px] border border-border/60 bg-card/95 shadow-[0_18px_44px_-24px_rgba(15,23,42,0.16)]">
            <div className="border-b border-border/60 px-6 py-5">
              <div className="space-y-1">
                ...
                <p className="text-sm leading-6 text-muted-foreground">
                  Vista consolidada del rendimiento individual para el período seleccionado.
                </p>
              </div>
            </div>
