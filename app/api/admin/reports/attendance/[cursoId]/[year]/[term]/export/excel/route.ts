...
export async function GET(request: NextRequest, context: RouteContext) {
  try {
    ...
    const url = new URL(
      `${BASE}/api/v1/reportes/cursos/${cursoIdNumber}/years/${yearNumber}/terms/${termNumber}/attendance/export/excel`
    )
    ...
    return proxyFile(
      ...
      `attendance-curso-${cursoIdNumber}-${yearNumber}-t${termNumber}.xlsx`
    )
  } catch (error) {
