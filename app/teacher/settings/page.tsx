        ...
        <div className="mx-auto max-w-5xl space-y-5">
          <header className="border-b border-border/60 pb-5">
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground sm:text-[15px]">
              Gestioná tu perfil docente y mantené actualizada la seguridad de
              acceso.
            </p>
          </header>
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="grid min-w-0 gap-5 lg:grid-cols-[minmax(0,1fr)_minmax(320px,380px)] lg:items-start">
                <AccountProfileForm
                  account={account}
                  onUpdated={(updated) => setAccount(updated)}
                  updateAccount={updateMyAccountSettings}
                  description="Foto y datos personales que aparecen en tu espacio docente."
                  showRoles={false}
                  avatarProps={{
            ...
            <CompactState
              ...
              description="No encontramos información disponible para esta cuenta docente."
            />
          )}
        </div>
      </main>
